...
<main class="" style="background-color: #0F0F0F;">
    <div class="row m-0 flex-nowrap">
        <div class="text-white col-9 p-0">
            <div class="my-3">
                <video width="1200" height="650" autoplay src="/videos/Rick_Astley_-_Never_Gonna_Give_You_Up_Official_Music_Video.mp4" controls style="object-fit: cover;"></video>
            </div>
        ...
        <div class="d-flex col-3 justify-content-center">
            <div class="d-flex flex-column">
                <h2 class="m-2 text-white">Video correlati</h2>
                @foreach ($videos as $video)
                <div class="m-1" style="width: 323px;"><a href="" style="text-decoration: none">
                        <div class="d-flex">
                            <div class="">
                            ...
                            <div class="d-flex flex-column px-2" style="width: 150px; height: 90px;">
                                ...
                                <span style="font-size: 14px; color: #AAAA;" class="">{{ $video->username }}</span>
                                <div class="">
                                    <span style="font-size: 13px; color: #AAAA;">{{ $video->views }} Views</span>
