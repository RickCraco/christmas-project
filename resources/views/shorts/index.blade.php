...
<main style="height: 100%; width: 100%;" class="d-flex flex-column gap-5 justify-content-center align-items-center">
    ...
    <div class="h-100 w-100 mt-1 d-flex justify-content-center">
        <video src="shorts/Dancing_Cat_Funny_.mp4" controls autoplay loop style="border-radius: 20px; height: 1200px;"></video>
